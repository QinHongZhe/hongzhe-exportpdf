...
@Controller
@RequestMapping("pdf")
public class SalesContractPdfController {
	...
	@GetMapping("/salesContractPdf")
	public @ResponseBody void salesContractPdf() throws DocumentException, IOException {
		// 告诉浏览器用什么软件可以打开此文件
		...
		PdfPCell createPdfPCell = pdfUtils.createPdfPCell("销售合同", PDFUtils.titleFont);
		...
		// 合同签订日期
		PdfPCell createPdfPCell3 = pdfUtils.createPdfPCell("合同签订日期:CGXXXXXX", PDFUtils.messFont, 1);
		createTable2.addCell(createPdfPCell3);
		// 客户名称
		PdfPCell createPdfPCell4 = pdfUtils.createPdfPCell("客户名称:CGXXXXXX", PDFUtils.messFont, 1);
		createTable2.addCell(createPdfPCell4);
		document.add(createTable2);
		// 客户编号
		PdfPTable createTable3 = pdfUtils.createTable(3, 100);
		PdfPCell createPdfPCell5 = pdfUtils.createPdfPCell("客户编号:CGXXXXXX", PDFUtils.messFont, 1);
		...
		// 付款方式
		PdfPCell createPdfPCell7 = pdfUtils.createPdfPCell("付款方式:CGXXXXXX", PDFUtils.messFont, 1);
		createTable3.addCell(createPdfPCell7);
		document.add(createTable3);
		// 交货方式
		PdfPTable createTable_4 = pdfUtils.createTable(3, 100);
		PdfPCell createPdfPCell_5 = pdfUtils.createPdfPCell("交货方式:CGXXXXXX", PDFUtils.messFont, 1);
		createTable_4.addCell(createPdfPCell_5);
		// 合同订金金额
		PdfPCell createPdfPCell_6 = pdfUtils.createPdfPCell("交货时间:", PDFUtils.messFont, 1);
		createTable_4.addCell(createPdfPCell_6);
		// 付款方式
		PdfPCell createPdfPCell_7 = pdfUtils.createPdfPCell("备注:CGXXXXXX", PDFUtils.messFont, 1);
		createTable_4.addCell(createPdfPCell_7);
		document.add(createTable_4);
		//制单人
		PdfPTable createTable6 = pdfUtils.createTable(3, 100);
		PdfPCell createPdfPCell17 = pdfUtils.createPdfPCell("制单人:张三", PDFUtils.messFont, 1);
		createTable6.addCell(createPdfPCell17);
		PdfPCell createPdfPCell171 = pdfUtils.createPdfPCell("业务员:李四", PDFUtils.messFont, 1);
		createTable6.addCell(createPdfPCell171);
		PdfPCell createPdfPCell1711 = pdfUtils.createPdfPCell("", PDFUtils.messFont, 1);
		createTable6.addCell(createPdfPCell1711);
		document.add(createTable6);
		
		PdfPTable createTable5 = pdfUtils.createTable(1,100);
		PdfPCell createPdfPCell16 = pdfUtils.createPdfPCell("销售合同明细",PDFUtils.messFont , 1);
