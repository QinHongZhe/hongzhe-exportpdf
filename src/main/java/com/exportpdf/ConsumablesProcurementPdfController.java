...
/**
 * @author TANGSHUAI
 * @date 2020年12月24日 下午2:31:05 消耗品采购打印
 */
@Controller
@RequestMapping("pdf")
public class ConsumablesProcurementPdfController {
	...
	@GetMapping("/consumablesProcurement")
	public @ResponseBody void consumablesProcurement() throws DocumentException, IOException {
		// 告诉浏览器用什么软件可以打开此文件
		...
		// 创建标题
		PdfPTable createTitle = pdfUtils.createTitle("消耗品采购申请");
		...
		// 消耗品采购单编号
		PdfPTable createExpenseManagement = pdfUtils.createExpenseManagement("消耗品采购单编号:", "GW");
		document.add(createExpenseManagement);
		// 消耗品采购日期
		PdfPTable createExpenseManagement2 = pdfUtils.createExpenseManagement("消耗品采购日期:", "2020-12-07");
		document.add(createExpenseManagement2);
		// 采购渠道
		PdfPTable createExpenseManagement3 = pdfUtils.createExpenseManagement("供应商:", "");
		...
		// 审批流程
		PdfPTable createTable_3 = pdfUtils.createTable(1, 100);
		PdfPCell createPdfPCell_7 = pdfUtils.createPdfPCell("采购明细", PDFUtils.messFont, 1);
		createTable_3.addCell(createPdfPCell_7);
		document.add(createTable_3);
		// 采购单明细
