...
/**
 * @author TANGSHUAI
 * @date 2020年12月13日 下午1:12:46 暂支单
 */
@Controller
@RequestMapping("pdf")
public class TemporaryLoanController {

	@Autowired
	private PDFUtils pdfUtils;

	@GetMapping(value = "/temporaryLoan")
	public void temporaryLoan(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// 创建标题
		PdfPTable createTitle = pdfUtils.createTitle("暂支单");
		...
		// 申请部门
		PdfPTable createExpenseManagement2 = pdfUtils.createExpenseManagement("申请部门:", "财务部");
		document.add(createExpenseManagement2);
		// 暂支事由
		PdfPTable createExpenseManagement3 = pdfUtils.createExpenseManagement("暂支事由:", "测试");
		document.add(createExpenseManagement3);
		// 暂支方式
		PdfPTable createExpenseManagement4 = pdfUtils.createExpenseManagement("暂支方式:", "");
		document.add(createExpenseManagement4);
		// 暂支金额
		PdfPTable createExpenseManagement5 = pdfUtils.createExpenseManagement("暂支金额:", "");
		document.add(createExpenseManagement5);
		// 还款方式
		PdfPTable createExpenseManagement6 = pdfUtils.createExpenseManagement("还款方式:", "");
		document.add(createExpenseManagement6);
		// 预计归还日期
		PdfPTable createExpenseManagement7 = pdfUtils.createExpenseManagement("预计归还日期:", "");
